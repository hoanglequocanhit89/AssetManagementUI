...
const FormModalWithSearch = (props: FormModalWithSearchProps) => {
    ...
    const { title, onSearchInput, onSubmit, closeModal, children } = props;
            ...
            <div className="form-modal-search">
                <div className="form-modal__inner">
                    ...
                    <div className="form-modal__action">
                        <Button color="primary" text="Save" onClick={() => onSubmit()} />
                        <Button color="outline" text="Cancel" onClick={() => closeModal()} />
                    </div>
                </div>
            </div>
        </>
